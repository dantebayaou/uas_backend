...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-primary bg-primary">
            <div class="container">
                <nav class="navbar bg-primary bg-opacity-10">
                    ...
                    <h2 style="color:white ;">Welcome to SuperStore official site!
                        <br/> <br />
                    </h2>
                </nav>
            </div>
        ...
        <div class="py-5 mb-2 bg-white container">
            <div class = "d-flex justify-content-between align-items-center">
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        <li class="page-item">
                            <a class="page-link bg-info text-light" href="#">Home Page</a>
                        </li>

                        <li class="page-item bg">
                            <a class="page-link bg-primary text-light" href="./data/index.php">Request Barang </a>
                        </li>
                    </ul>
                </nav>
            ...
            <h2 class = "py-4" >Menampilkan data</h2>
