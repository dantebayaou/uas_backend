<?php
    require_once('../../../controllers/Data/AddDataPermintaan.php');
    ...
    if (isset($_POST['submit_permintaan'])) {
        $nama = $_POST['nama_permintaan'];
        $keterangan = $_POST['keterangan'];
        $harga = $_POST['harga'];

        $Controller = new AddDataPermintaanController();

        if ($Controller->AddData($nama, $keterangan, $harga)) {
            $notif = true;
        } else {
            $notif = false;
        }
...
<html lang="en">
    ...
    <body>
        <script>
            ...
            <?php if($notif){ ?>alert("Permintaan berhasil di proses"); <?php } ?>
        </script>
        ...
        <nav class="navbar navbar-expand-lg navbar-primary bg-primary">
            <div class="container">
                <nav class="navbar bg-primary bg-opacity-10">
                    ...
                    <h2 style="color:white ;">Request Barang, jika belum ada di web kami.
                        <br/> <br />
                    </h2>
                </nav>
            </div>
        ...
        <div class="py-5 mb-2 bg-white container">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        <li class="page-item bg">
                            <a class="page-link bg-primary text-light" href="../index.php">Home Page</a>
                        </li>

                        <li class="page-item">
                            <a class="page-link bg-info text-light" href="#">Request Barang </a>
                        </li>
                    </ul>
                </nav>
            ...
            <h3 class = "text-center pb-4"> Form request barang </h3>
            ...
            <div>
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_permintaan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                    </div>
                    ...
                    <input type="submit" name="submit_permintaan" class="btn btn-primary" value = "Submit" />
