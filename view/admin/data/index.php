<?php 
    ...
    require_once('../../../controllers/Data/GetDataPermintaan.php');
    ...
    $Controller = new GetDataPermintaanController();
...
<html lang="en">
    ...
    <body>
        ...
        <div class="py-5 mb-2 bg-white container">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        ...
                        <li class="page-item bg">
                            <a class="page-link bg-info text-light fs-6" href="#">Barang Request Masuk </a>
                        </li>

                        <li class="page-item bg">
                            <a class="page-link bg-primary text-light fs-6" href="add-barang.php">Tambah Data </a>
                        </li>
            ...
            <h2 class = "py-4" >Data Request Masuk</h2>
                ...
                <table class="table table-hover table-striped text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href = "delete-permintaan.php?id=<?php echo $row['id'] ?>" class = "btn btn-danger">Hapus</a>
                            </td>
                        </tr>
